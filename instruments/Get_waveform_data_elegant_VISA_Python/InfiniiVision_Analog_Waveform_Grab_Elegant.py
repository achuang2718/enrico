...
SCOPE_VISA_ADDRESS = "TCPIP0::192.168.1.9::inst0::INSTR" # Get this from Keysight IO Libraries Connection Expert
...
rm = visa.ResourceManager('C:\\Windows\\System32\\visa64.dll') # this uses PyVisa
